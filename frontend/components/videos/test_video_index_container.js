...
import TestVideoIndex from './test_video_index'; // presentational component to connect
...
export default connect(mapStateToProps, mapDispatchToProps)(TestVideoIndex);